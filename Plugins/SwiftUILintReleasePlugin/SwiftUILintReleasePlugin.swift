...
@main
struct SwiftUILintReleasePlugin: BuildToolPlugin {
...
extension SwiftUILintReleasePlugin: XcodeBuildToolPlugin {
    ...
    func createBuildCommands(context: XcodePluginContext, target: XcodeTarget) throws -> [Command] {
        ...
        return [
            .buildCommand(
                ...
                executable: try context.tool(named: "swiftuilint").path,
